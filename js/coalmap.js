...
$(document).ready(function() {
    ...
    $.ajax({
            type: 'GET',
            url: 'https://developer.nrel.gov/api/pvwatts/v5.json?api_key=' + apikey + '&lat=40&lon=-105&system_capacity=4&azimuth=180&tilt=40&array_type=1&module_type=1&losses=10',
            dataType: "jsonp",
            crossDomain: true,
